...
tables[0] = new Table( 0, 'Table for 10', eventEmitter(0), 10, 2, 1, 200, 40, false );
tables[1] = new Table( 1, 'Table for 6', eventEmitter(1), 6, 2, 1, 400, 80, false );
tables[2] = new Table( 2, 'Table for 2', eventEmitter(2), 2, 2, 1, 800, 160, false );